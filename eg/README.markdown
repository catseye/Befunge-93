...
| [digitalr.bf](digitalr.bf) |         | Keymaker            | 9/3/108  | Computes the digital root of the word (see `numer.bf`) given in the input. The input must be terminated with ASCII NUL (character 0; can sometimes be typed in as Ctrl+@.)
